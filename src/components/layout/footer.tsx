...
export function Footer() {
    return (
        <footer className="relative z-10 py-6 px-6 border-t border-zinc-100 dark:border-zinc-800/50 bg-white/50 dark:bg-zinc-950/50 backdrop-blur-sm mt-auto">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex flex-col items-center order-1 md:order-2">
                    ...
                    >
                        <GitBranch className="h-3.5 w-3.5 text-zinc-400 dark:text-zinc-500 group-hover:text-white dark:group-hover:text-zinc-900 transition-colors" />
