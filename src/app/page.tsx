...
export default function LandingPage() {
  return (
    <div className="relative flex-1 flex flex-col overflow-hidden bg-gradient-to-br from-white via-pink-50/30 to-pink-100/50">

      {/* Wavy Background Decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Top right curve */}
        <div className="absolute -top-20 -right-20 md:-right-40 w-[300px] md:w-[600px] h-[300px] md:h-[600px] rounded-full bg-gradient-to-br from-pink-200/40 to-pink-300/20 blur-3xl" />
        {/* Bottom left curve */}
        <div className="absolute -bottom-20 -left-20 md:-left-40 w-[250px] md:w-[500px] h-[250px] md:h-[500px] rounded-full bg-gradient-to-tr from-pink-200/50 to-pink-100/30 blur-3xl" />
        {/* Center glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] md:w-[800px] h-[200px] md:h-[400px] rounded-full bg-gradient-to-r from-transparent via-pink-100/40 to-transparent blur-3xl" />
      </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 sm:px-8 py-8 sm:py-12">
        <div className="w-full max-w-sm sm:max-w-md space-y-6 sm:space-y-8 text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-1 sm:gap-2">
            ...
            <div className="space-y-2 sm:space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-zinc-800">
                Analytics
              </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 pt-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 w-full max-w-4xl px-4">
          <div className="flex items-center gap-2 px-5 py-3 rounded-xl 
            ...
            <div className="p-1.5 rounded-lg bg-pink-100 shrink-0">
              <Zap className="h-4 w-4 text-pink-600" />
            </div>
            <span className="text-sm font-medium text-zinc-700 whitespace-nowrap">Instant Insights</span>
          </div>
          <div className="flex items-center gap-2 px-5 py-3 rounded-xl 
                          bg-white/80 
                          border border-zinc-200
            ...
            <span className="text-sm font-medium text-zinc-700 whitespace-nowrap">Private & Secure</span>
          </div>
          <div className="flex items-center gap-2 px-5 py-3 rounded-xl 
                          bg-white/80 
                          border border-zinc-200
            ...
            <span className="text-sm font-medium text-zinc-700 whitespace-nowrap">Local Processing</span>
          </div>
        </div>
      </main>
